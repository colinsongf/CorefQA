...
def create_custom_optimizer(tvars, loss, bert_init_lr, task_init_lr, num_train_steps, num_warmup_steps, use_tpu,
                            global_step=None, freeze=-1, task_opt='adam', eps=1e-6):
    ...
    if task_opt == 'adam_weight_decay':
        ...
        task_optimizer = RAdam(learning_rate=task_learning_rate, epsilon=1e-8, beta1=0.9, beta2=0.999)
    else:
